...
public class RequesterRegisterDtoValidator : AbstractValidator<RequesterRegisterDto>
{
    public RequesterRegisterDtoValidator(IStringLocalizer<SharedResource> localizer)
    {
        ...
        RuleFor(x => x.Role)
            .NotEmpty()
            .Must(role => role == RolesEnum.Requester.ToString())
